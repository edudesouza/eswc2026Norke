...
async def main(user_id,pergunta,retrieval='grafo',retrieval_size=5,size_gt=5,debug_all=False,debug_one=[],output=False):  
    ...
    expantion = keywords_create(pergunta,'gpt-4.1',settings.OPENAI_API_KEY)
    ...
    task_ground_truth           = asyncio.to_thread(ground_truth,contexto,pergunta,palavras_chave,'gpt',size_gt)
