...
if __name__ == "__main__":
    ...
    pergunta = 'Can I refuse to give my fingerprint to the company s time clock?'
    resposta = 'Yes, in many cases. Biometric data is a special category under Article 9 GDPR and requires necessity and proportionality. If alternatives exist, you may object, especially given the imbalance in employment relationships.'
